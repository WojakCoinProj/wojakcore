    ...
    mapper(nullptr)
{
    ...
    ui->wojakcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->wojakcoinAtStartup);
    ...
    ui->wojakcoinAtStartup->setToolTip(ui->wojakcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->wojakcoinAtStartup->setText(ui->wojakcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openWojakcoinConfButton->setToolTip(ui->openWojakcoinConfButton->toolTip().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->wojakcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openWojakcoinConfButton_clicked()
{
