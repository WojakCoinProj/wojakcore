...
const std::string CURRENCY_UNIT = "WJK"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    WJK_KVB,      //!< Use WJK/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from WJK/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::WJK_KVB) const;
