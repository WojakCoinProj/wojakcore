...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("WojakCore wojakcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
            "  wojakcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wojakcoin transaction") + "\n" +
            "  wojakcoin-tx [options] -create [commands]   " + _("Create hex-encoded wojakcoin transaction") + "\n" +
            "\n";
